...
class SocServiceRefeViewSet(viewsets.ModelViewSet, Common):
    permission_classes = [HasSocServiceRefePErmission]
    serializer_class = SocServiceRefeSerializer
    queryset = SocServiceRefe.objects.all()
